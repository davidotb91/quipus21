...
//        ObjListaIngreso.show();
        FacturaIngresos objFact = new FacturaIngresos();
        desktopPane.add(objFact);
        Dimension desktopSize = desktopPane.getSize();
        Dimension FrameSize = objFact.getSize();
        objFact.setLocation((desktopSize.width - FrameSize.width)/2, (desktopSize.height- FrameSize.height)/2);
        objFact.show();
